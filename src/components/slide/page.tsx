    ...
    >
      ...
      <div className="lg:w-1/2 mb-8 lg:mb-0">
        ...
        <h5 className="text-base lg:text-xl mt-4 lg:mt-5 font-normal text-gray-600">
          Shopping online with us is more than just a transaction. It's a journey of discovery,
          ...
          your needs and desires. Whether you're looking for fashion, electronics, home goods, or
          more, we're here to facilitate your learning and provide you with the best shopping
          experience possible.
        </h5>
        {/* <div className="mt-4 lg:mt-2 flex items-center">
          <Button
            className="font-medium font-roboto mt-3 px-5 py-2 border-2 border-blue-600 rounded-full text-white bg-blue-600 transition duration-500 hover:text-blue-600 hover:bg-white"
            color="default"
          >
            Get Started
          </Button>
